...
from neuro_comma_master.src.neuro_comma.dataset import BaseDataset
...
from neuro_comma_master.src.neuro_comma.utils import get_last_pretrained_weight_path, load_params


class BasePredictor:
    def __init__(self,
                 model_name: str,
                 models_root: Path = Path("C:\\Users\\Maksim\\Desktop\\voice_intel\\neuro_comma_master\\models"),
